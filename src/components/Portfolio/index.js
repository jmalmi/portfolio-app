        ...
        <PortfolioContainer id="portfolio">
            ...
            <PortfolioWrapper>
                ...
                <PortfolioCard onClick={() => window.open('https://student.labranet.jamk.fi/~AB5141/portfolio')}>
                    ...
                    <PortfolioP>Sivut on tehty käyttäen React scrollia ja routteria</PortfolioP>
                </PortfolioCard>
                <PortfolioCard onClick={() => window.open('https://student.labranet.jamk.fi/~AB5141/mok/weather/')}>
                    <PortfolioIcon src={Icon2} />
                    <PortfolioH2>React sää</PortfolioH2>
                    <PortfolioP>Pieni sää sovellus reactilla ja axioksella</PortfolioP>
                </PortfolioCard>
                <PortfolioCard onClick={() => window.open('https://student.labranet.jamk.fi/~AB5141/mok/redux-shop/')}>
                    <PortfolioIcon src={Icon3} />
                    <PortfolioH2>React kauppa</PortfolioH2>
                    <PortfolioP>Kauppa sovellus reactilla. Axios & Redux</PortfolioP>
                </PortfolioCard>
                <PortfolioCard onClick={() => window.open('https://student.labranet.jamk.fi/~AB5141/mok/movies/')}>
                    <PortfolioIcon src={Icon4} />
                    <PortfolioH2>Movies app</PortfolioH2>
                    <PortfolioP>Elokuva sovellus. Axios, modal, youtube</PortfolioP>
                </PortfolioCard>
                <PortfolioCard onClick={() => window.open('https://student.labranet.jamk.fi/~AB5141/mok/busses/')}>
                ...
                <PortfolioCard onClick={() => window.open('https://student.labranet.jamk.fi/~AB5141/mok/consumption/')}>
                    <PortfolioIcon src={Icon6} />
                    <PortfolioH2>Car Consumption</PortfolioH2>
                    <PortfolioP>Sovellus jolla voi tarkkailla ja tallentaa auton kulutusta</PortfolioP>
                </PortfolioCard>
            </PortfolioWrapper>
        </PortfolioContainer>
    )
